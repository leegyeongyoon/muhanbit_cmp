...
public class searchDAO {
	...
	public List<Maintenancebean> search_select_ma(searchbean searchbean, String currentPage1) {
		...
		try {
				...
				case "go_date":  sql += "l.go_date LIKE  ? "+sqlend; totalsql  += "l.go_date LIKE  ? "+sqlend; break; 
				case "sort":     sql += "c.sort LIKE     ? "+sqlend; totalsql  += "c.sort LIKE  ? "+sqlend; break;
				case "type":     sql += "l.type LIKE     ? "+sqlend; totalsql  += "l.type LIKE  ? "+sqlend; break;
				case "title":    sql += "c.title LIKE    ? "+sqlend; totalsql  += "c.title LIKE  ? "+sqlend; break;
				case "content":  sql += "l.content LIKE  ? "+sqlend; totalsql  += "l.content LIKE  ? "+sqlend; break;
				case "op":       sql += "l.op LIKE       ? "+sqlend; totalsql  += "l.io LIKE  ? "+sqlend; break;
				case "customer": sql += "l.customer LIKE ? "+sqlend; totalsql  += "l.customer LIKE  ? "+sqlend; break;
				}
	...
	public List<companybean> search_select_cu(searchbean searchbean, String currentPage1) {
		...
		try {
				...
				switch(searchbean.getTitle()) {
				case "name":  sql += "name LIKE  ? "+sqlend; totalsql += "name LIKE  ? "+sqlend; break; 
				case "manager":     sql += "manager  LIKE ?"+sqlend; totalsql += "manager LIKE  ? "+sqlend; break;
				case "phone":     sql += "phone      LIKE ?"+sqlend; totalsql  += "phone LIKE  ? "+sqlend; break;
				case "email":    sql += "email       LIKE ?"+sqlend; totalsql  += "email LIKE  ? "+sqlend; break;
				case "address":  sql += "address     LIKE ?"+sqlend; totalsql  += "address LIKE  ? "+sqlend; break;
